...
for (i in 1:length(fraction_data$Temp)){
  ...
  times <- seq(from=0,to=5,by=1) #for params w/ high I to test model
  ...
  parms <-c(psi=0.5, KH=1, beta=0.00005,p=0.0005,m=0.000001,
            gamma=100,KI=20000,alpha=0.85,KB=2000000,w=0.0005,z=0.001,
            r=6000,d=0.003,c=1,sigma=500000,TCI=TCI,TII=TII,TB=TB) #params w/ high I to test model
